...
const campgrounds=require('../cotrollers/campgrounds')
...
router.route('/')
    ...
    .post(isLoggedIn, upload.array('image',4),validateCampground,catchAsync(campgrounds.CreateCampground))
...
router.route('/:id')
    ...
    .put(isLoggedIn, isAuthor, upload.array('image',4), validateCampground, catchAsync(campgrounds.updateCampground))
